Doom Legacy 1.48.19 (1773)  [Underbuild 002: 2026-01-28]
 ...
 !=================================================================================================!
  Update: Underbuild 002
	- Standard Einstellung ohne config "32Bit" und "Fullscreen" aus.
  ...
  - Lightening the text when you select Screen Mode or Draw Mode for better readability.
    ...
    - Fixed a 15-bit crash. I had to modify the SDL1 library myself.
		  Ist ein bisschen tricky ohne nun an DL großartig rumzuschrauben.
			Mein Desktop/ Graka Treiber bietet kein 15bit weder 24Bit an.
	  - Centering of the window mode also in the SDL1 version
	  - Added Borderless Mode
		- Commandline ausgabe läuft auch unter CMD
	...
	* Todo
	24Bit Modus? Ich kann das Pixelformat nicht forcieren. Somit kein test od as läuft.
	
	SDL2: Fullscreen Desktop/ Exclusive Fullscreen-Resolutions-Fix
	SDL1: 8Bit modus Vollbirlschirm, ach du kacke alles Grau ... braucht man das noch?
	SDL2: 8Bit modus ... braucht man das noch?
	
	Fehlt Anpassung des Makefile.
	Upate des SDL2 Video Code noch nicht mit dem von SDL1 verschmolzen
	So, 
  (*)
  Screenmodes:
