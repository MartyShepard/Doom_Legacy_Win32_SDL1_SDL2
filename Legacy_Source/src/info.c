...
// [WDJ] Usage:
// MFLAGS( MF_xxx, MF2_xxx, MF3_xxx )
#ifdef MOBJ_HAS_FLAGS3
#define  MFLAGS( f1, f2, f3 )   f1, f2, f3
#else
#define  MFLAGS( f1, f2, f3 )   f1, f2,
#endif

// [WDJ] Usage:
// MFLAGS( MF_xxx, MF2_xxx, MBF21flags( MF3_yyy ) )
// MFLAGS( MF_xxx, MF2_xxx, MF3_xxx | MBF21flags( MF3_yyy ) )
// At this time, nothing bad will happen if a MBF21 flag
// is used outside of MBF21FLAGS().
#ifdef MBF21
#define  MBF21FLAGS( f4 )       f4
#else
#define  MBF21FLAGS( f4 )       0
#endif
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] = {
    ...
    {           // MT_PLAYER
        ...
        100,            // mass
        0,              // damage
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_DROPOFF|MF_PICKUP|MF_NOTDMATCH,  // flags
...
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,  // flags
        0,
        MBF21FLAGS( MF3_DMGIGNORED | MF3_NOTHRESHOLD | MF3_SHORTMRANGE )  // flags3
      ),
        0,
    },
    ...
    {           // MT_FIRE
        ...
        100,            // mass
        0,              // damage
MFLAGS( MF_NOBLOCKMAP|MF_NOGRAVITY|MF_TRANSLUCENT,  // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,  // flags
        0,
        MBF21FLAGS( MF3_LONGMELEE | MF3_RANGEHALF )
      ),
        0,
    },
    ...
    {           // MT_TRACER
        ...
        100,            // mass
        10,             // damage
MFLAGS( MF_NOBLOCKMAP|MF_MISSILE|MF_DROPOFF|MF_NOGRAVITY|MF_TRANSLUCENT,  // flags
...
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,  // flags
        0,
        MBF21FLAGS( MF3_MAP07_BOSS1 ) // flags3
      ),
        0,
    },
...
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,  // flags
    ...
    {           // MT_SHADOWS
        ...
        400,            // mass
        0,              // damage
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_SHADOW|MF_COUNTKILL,  // flags
        0,
        0
      ),
        0,
    ...
    {           // MT_HEAD
        ...
        400,            // mass
        0,              // damage
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_FLOAT|MF_NOGRAVITY|MF_COUNTKILL,   // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,  // flags
    ...
    {           // MT_SKULL
        ...
        50,             // mass
        3,              // damage
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_FLOAT|MF_NOGRAVITY|MF_TRANSLUCENT,  // flags
           // was not translucent in Boom
        0,
        MBF21FLAGS( MF3_RANGEHALF )
      ),
        0,
    },
...
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,  // flags
        0,
        MBF21FLAGS( MF3_E3M8_BOSS | MF3_E4M8_BOSS | MF3_RANGEHALF | MF3_FULLVOLSOUNDS )  // flags3
      ),
        0,
    },
...
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,  // flags
    ...
    {           // MT_KEEN
        ...
        10000000,               // mass
        0,              // damage
MFLAGS( MF_SOLID|MF_SPAWNCEILING|MF_NOGRAVITY|MF_SHOOTABLE|MF_COUNTKILL,  // flags
        0,
        0
      ),
        0,
    ...
    {           // MT_BOSSBRAIN
        ...
        10000000,               // mass
        0,              // damage
MFLAGS( MF_SOLID|MF_SHOOTABLE,  // flags
        0,
        0
      ),
        0,
    ...
    {           // MT_BOSSSPIT
        ...
        100,            // mass
        0,              // damage
MFLAGS( MF_NOBLOCKMAP|MF_NOSECTOR,  // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_NOBLOCKMAP|MF_NOSECTOR,  // flags
    ...
    {           // MT_SPAWNSHOT
        ...
        100,            // mass
        3,              // damage
MFLAGS( MF_NOBLOCKMAP|MF_MISSILE|MF_DROPOFF|MF_NOGRAVITY|MF_NOCLIP,  // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_NOBLOCKMAP|MF_NOGRAVITY|MF_TRANSLUCENT,  // flags
    ...
    {           // MT_BARREL
        ...
        100,            // mass
        0,              // damage
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_NOBLOOD,   // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_NOBLOCKMAP|MF_MISSILE|MF_DROPOFF|MF_NOGRAVITY|MF_TRANSLUCENT,  // flags
    ...
    {           // MT_ROCKET
        ...
        100,            // mass
        20,             // damage
MFLAGS( MF_NOBLOCKMAP|MF_MISSILE|MF_DROPOFF|MF_NOGRAVITY,   // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_NOBLOCKMAP|MF_MISSILE|MF_DROPOFF|MF_NOGRAVITY|MF_TRANSLUCENT,  // flags
    ...
    {           // MT_PUFF
        ...
        100,            // mass
        0,              // damage
MFLAGS( MF_NOBLOCKMAP|MF_NOGRAVITY|MF_NOCLIP|MF_TRANSLUCENT,  // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_NOBLOCKMAP|MF_NOSECTOR,  // flags
    ...
    {           // MT_EXTRABFG
        ...
        100,            // mass
        0,              // damage
MFLAGS( MF_NOBLOCKMAP|MF_NOGRAVITY,  // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_SPECIAL,  // flags
    ...
    {           // MT_MISC2
        ...
        100,            // mass
        0,              // damage
MFLAGS( MF_SPECIAL|MF_COUNTITEM,  // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_SPECIAL|MF_COUNTITEM,  // flags
    ...
    {           // MT_MISC4
        ...
        100,            // mass
        0,              // damage
MFLAGS( MF_SPECIAL|MF_NOTDMATCH,  // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_SPECIAL,  // flags
    ...
    {           // MT_MISC12
        ...
        100,            // mass
        0,              // damage
MFLAGS( MF_SPECIAL|MF_COUNTITEM|MF_TRANSLUCENT,  // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_SOLID,   // flags
    ...
    {           // MT_MISC51
        ...
        100,            // mass
        0,              // damage
MFLAGS( MF_SOLID|MF_SPAWNCEILING|MF_NOGRAVITY,  // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_SOLID|MF_SPAWNCEILING|MF_NOGRAVITY,  // flags
    ...
    {           // MT_MISC56
        ...
        100,            // mass
        0,              // damage
MFLAGS( MF_SPAWNCEILING|MF_NOGRAVITY,  // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_NOBLOCKMAP,  // flags
    ...
    {           // MT_CHASECAM
        ...
        100,            // mass
        0,              // damage
MFLAGS( MF_NOBLOCKMAP|MF_NOSECTOR|MF_NOGRAVITY|MF_FLOAT,  // flags
    ...
    {           // MT_SPIRIT
        ...
        100,            // mass                            100,            // mass
        0,              // damage                          0,              // damage
MFLAGS( /*MF_NOBLOCKMAP|MF_NOSECTOR|*/MF_DROPOFF,  // flags    MF_SOLID|MF_SHOOTABLE|MF_PICKUP|MF_NOTDMATCH,
        MF2_SLIDE,
        0
      ),
        0,
    ...
    {           // MT_SMOK test v1.25 smoke from lava/slime damage
        ...
        100,                    // mass
        0,                      // damage
MFLAGS( MF_NOBLOCKMAP|MF_NOGRAVITY|MF_NOCLIP,  // flags
        0,
        0
      ),
        0,
...
MFLAGS( MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,  // flags
      ...
      100,            // mass
      0,              // damage
MFLAGS( MF_NOSECTOR|MF_NOBLOCKMAP,  // flags
        0,  // flags2
        0
      ),
      0,
...
MFLAGS( MF_NOSECTOR|MF_NOBLOCKMAP,  // flags
    ...
    {   // MT_CAMERA
      ...
      10,             // mass
      0,              // damage
MFLAGS( MF_NOBLOCKMAP|MF_NOCLIP|MF_NOGRAVITY|MF_NOSECTOR,  // flags
        MF2_SLIDE,
        0
      ),
      0,
    ...
    {   // MT_NODE
      ...
      10,             // mass
      0,              // damage
MFLAGS( MF_NOBLOCKMAP|MF_NOCLIP|MF_NOSECTOR|MF_NOGRAVITY,  // flags
        0,
        0
      ),
      0,
...
MFLAGS( MF_SPECIAL | MF_COUNTITEM,  // flags
    ...
    {                           // MT_ARTIINVISIBILITY
     ...
     100,                       // mass
     0,                         // damage
MFLAGS( MF_SPECIAL | MF_SHADOW | MF_COUNTITEM,  // flags
        MF2_FLOATBOB,  // flags2
        0
      ),
      0,
...
MFLAGS( MF_SPECIAL | MF_COUNTITEM,  // flags
    ...
    {                           // MT_FIREBOMB
     ...
     100,                       // mass
     0,                         // damage
MFLAGS( MF_NOGRAVITY | MF_SHADOW,  // flags
        0,  // flags2
        0
      ),
      0,
...
MFLAGS( MF_SPECIAL | MF_COUNTITEM,  // flags
    ...
    {                           // MT_POD
     ...
     100,                       // mass
     0,                         // damage
MFLAGS( MF_SOLID | MF_NOBLOOD | MF_SHOOTABLE | MF_DROPOFF,  // flags
    ...
    {                           // MT_PODGOO
     ...
     100,                       // mass
     0,                         // damage
MFLAGS( MF_NOBLOCKMAP | MF_MISSILE | MF_DROPOFF,   // flags
...
MFLAGS( MF_NOBLOCKMAP,  // flags
    ...
    {                           // MT_LAVASMOKE
     ...
     100,                       // mass
     0,                         // damage
MFLAGS( MF_NOBLOCKMAP | MF_NOGRAVITY | MF_SHADOW,  // flags
        0,  // flags2
        0
      ),
      0,
...
MFLAGS( MF_SOLID,  // flags
    ...
    {                           // MT_KEYGIZMOFLOAT
     ...
     100,                       // mass
     0,                         // damage
MFLAGS( MF_SOLID | MF_NOGRAVITY,   // flags
        0,  // flags2
        0
      ),
      0,
...
MFLAGS( MF_NOBLOCKMAP | MF_MISSILE | MF_DROPOFF,   // flags
    ...
    {                           // MT_TELEGLITGEN
     ...
     100,                       // mass
     0,                         // damage
MFLAGS( MF_NOBLOCKMAP | MF_NOGRAVITY | MF_NOSECTOR,  // flags
        0,  // flags2
        0
      ),
      0,
...
MFLAGS( MF_NOBLOCKMAP | MF_NOGRAVITY | MF_NOSECTOR,  // flags
    ...
    {                           // MT_TELEGLITTER
     ...
     100,                       // mass
     0,                         // damage
MFLAGS( MF_NOBLOCKMAP | MF_NOGRAVITY | MF_MISSILE,  // flags
        0,  // flags2
        0
      ),
      0,
...
*/
    {                           // MT_BLOODYSKULL
     ...
     100,                       // mass
     0,                         // damage
MFLAGS( MF_NOBLOCKMAP | MF_DROPOFF,  // flags
    ...
    {                           // MT_CHICPLAYER
     ...
     100,                       // mass
     0,                         // damage
MFLAGS( MF_SOLID | MF_SHOOTABLE | MF_DROPOFF | MF_NOTDMATCH,  // flags
    ...
    {                           // MT_CHICKEN
     ...
     40,                        // mass
     0,                         // damage
MFLAGS( MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL | MF_DROPOFF,  // flags
...
MFLAGS( MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL,  // flags
    ...
    {                           // MT_MUMMYGHOST
     ...
     75,                        // mass
     0,                         // damage
MFLAGS( MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL | MF_SHADOW,  // flags
        MF2_FOOTCLIP | MF2_PASSMOBJ,  // flags2
        0
      ),
     0,
...
MFLAGS( MF_NOBLOCKMAP | MF_MISSILE | MF_DROPOFF | MF_NOGRAVITY,  // flags
    ...
    {                           // MT_HEAD
     ...
     325,                       // mass
     0,                         // damage
MFLAGS( MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL | MF_NOBLOOD,  // flags
        MF2_PASSMOBJ,  // flags2
        0
      ),
     0,
...
MFLAGS( MF_NOBLOCKMAP | MF_MISSILE | MF_DROPOFF | MF_NOGRAVITY,  // flags
    ...
    {                           // MT_WHIRLWIND
     ...
     100,                       // mass
     1,                         // damage
MFLAGS( MF_NOBLOCKMAP | MF_MISSILE | MF_DROPOFF | MF_NOGRAVITY | MF_SHADOW,  // flags
        MF2_NOTELEPORT,  // flags2
        0
      ),
     0,
...
MFLAGS( MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL | MF_NOBLOOD,  // flags
    ...
    {                           // MT_WIZARD
     ...
     100,                       // mass
     0,                         // damage
MFLAGS( MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL | MF_FLOAT | MF_NOGRAVITY,  // flags
        MF2_PASSMOBJ,  // flags2
        0
      ),
     0,
