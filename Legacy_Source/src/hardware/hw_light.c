...
// --------------------------------------------------------------------------
static
float HWR_DistP2D(vxtx3d_t* p1, vxtx3d_t* p2, v3d_t* p3, /*OUT*/ v3d_t* inter)
{
    if (p1->z == p2->z) {
        inter->x = p3->x;
        inter->z = p1->z;
...
static
void HWR_AddLightMapForLine( int lightnum, seg_t* line)
{
    /*
    int                 x1;
    int                 x2;
...
// --------------------------------------------------------------------------
static
void HWR_AddMobjLights(mobj_t* thing)
{
