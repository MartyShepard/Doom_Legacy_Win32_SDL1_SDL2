...
void S_Start_LevelSound(void)
{
    ...
    // HACK FOR COMMERCIAL
    //  if (gamemode == GM_doom2_commercial && mnum > mus_e3m9)
    //      mnum -= mus_e3m9;
                            ...
                            /*OUT*/ sound_param_t * sp )
{
    ...
    approx_dist = FIXED_TO_INT(adx + ady - (((adx < ady)? adx : ady) >> 1));
...
#endif
    {
        ...
        sp->sep =  - FIXED_TO_INT(FixedMul(S_STEREO_SWING, sine_ANG(angle)));
    }
